    ...
    const Modal = () => {
        return (
            <div className='overlay'>
                <div className='modal bg-gray-300 h-96 flex lg:w-3/5 md:w-4/5 w-full rounded-sm space-y-4 flex-col justify-center items-center absolute top-0 left-0 right-0 bottom-0 m-auto p-2'>
                    <button onClick={closeModal} className='absolute top-0 right-0 py-2 px-4 rounded-full bg-indigo-500 shadow-lg text-white hover:bg-red-500 hover:border-4 hover:shadow-none hover:border-indigo-500 m-2'>X</button>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 relative mx-auto">
                ...
                <div className="text-center my-3 bg-gray-600 shadow-xl rounded py-2 mx-4">
                    ...
                    <form ref={form} onSubmit={handleSubmit(sendEmail)} className="md:w-5/6 w-full mx-auto md:px-0 px-2">
                        ...
                        <input type="submit" value="Send Message" className="px-10 mb-3 py-2 rounded cursor-pointer bg-coral hover:bg-green-custom text-white text-xl" />
                    </form>
                </div>
