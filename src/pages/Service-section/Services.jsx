  ...
  return (
    <div id="services" className="bg-gray-200 lg:py-10 md:py-8 py-6 text-white lg:px-10 md:px-6 px-3">
      <div className="text-center text-green-custom">
        ...
        <p className="sm:w-4/5 w-full mx-auto pt-3 text-gray-700">
          Here is a few category of services that I provide. I have worked on so many projects, related to web app
          development. So, I will be happy to serve you these kind of service.
        </p>
      </div>
      <div className="grid lg:grid-cols-3 pt-10 md:grid-cols-2 grid-cols-1 gap-8 gap-y-6 md:px-8 px-2">
        {services.map((service) => (
          <div
            key={service.id}
            className="shadow-xl space-y-3 bg-gray-900 hover:bg-white hover:text-gray-900 transition ease-linear duration-200 rounded-xl p-8">
