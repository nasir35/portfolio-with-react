  ...
  return (
    <div className="md:p-10 sm:p-5 p-3 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 md:gap-8 gap-3 bg-gray-200">
      <div id="logo-slogan-section" className="col-span-1">
        <Link to="/">
          <img src={logo1} className="xl:w-1/3 md:w-2/4 w-1/3 pb-4 cursor-pointer" alt="logo" />
        </Link>
      ...
      <div id="links-section" className="col-span-1">
        ...
        <ScrollLink to="banner" smooth={true} offset={-50} duration={400} className="block cursor-pointer">
          &emsp;<i className="fas fa-link"></i> Home
        </ScrollLink>
        <ScrollLink to="portfolio" smooth={true} offset={-50} duration={400} className="block cursor-pointer">
          &emsp;<i className="fas fa-link"></i> Portfolio
        </ScrollLink>
        <ScrollLink to="services" smooth={true} offset={-50} duration={400} className="block cursor-pointer">
          &emsp;<i className="fas fa-link"></i> Services
        </ScrollLink>
        <a
      ...
      <div className="md:col-span-3 sm:col-span-2 col-span-1 pt-4">
        <p
          ...
          <span className="bg-gray-200 px-2">
            &copy; 2021-{new Date().getFullYear()} ~ All Rights reserved ~ Nasir&#x2122;
          </span>
        </p>
      </div>
    </div>
